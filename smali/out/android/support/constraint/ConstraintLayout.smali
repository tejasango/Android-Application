...
.method private internalMeasureDimensions(II)V
    ...
    iget-wide v11, v8, Landroid/support/constraint/solver/Metrics;->measures:J

    const-wide/16 v18, 0x1

    add-long v11, v11, v18

    iput-wide v11, v8, Landroid/support/constraint/solver/Metrics;->measures:J
    ...
    .restart local v12    # "childHeightMeasureSpec":I
    :cond_7b
    move/from16 v20, v11
    ...
    .end local v11    # "childWidthMeasureSpec":I
    .end local v12    # "childHeightMeasureSpec":I
    .restart local v20    # "childWidthMeasureSpec":I
    .restart local v21    # "childHeightMeasureSpec":I
    :goto_7f
    const/4 v8, -0x2
    ...
    :goto_85
    invoke-virtual {v15, v9}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setWidthWrapContent(Z)V
    ...
    :goto_8d
    invoke-virtual {v15, v8}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setHeightWrapContent(Z)V
    ...
    .local v8, "height":I
    invoke-virtual {v15, v6}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setWidth(I)V
    ...
    .line 1337
    invoke-virtual {v15, v6}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setWrapWidth(I)V
    ...
    .line 1340
    invoke-virtual {v15, v8}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setWrapHeight(I)V

    .line 1343
    :cond_a8
    iget-boolean v9, v10, Landroid/support/constraint/ConstraintLayout$LayoutParams;->needsBaseline:Z
    ...
    if-eq v9, v11, :cond_b6

    .line 1346
    invoke-virtual {v15, v9}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setBaselineDistance(I)V

    .line 1350
    .end local v9    # "baseline":I
    :cond_b6
    iget-boolean v9, v10, Landroid/support/constraint/ConstraintLayout$LayoutParams;->horizontalDimensionFixed:Z

    if-eqz v9, :cond_dc

    iget-boolean v9, v10, Landroid/support/constraint/ConstraintLayout$LayoutParams;->verticalDimensionFixed:Z
    ...
    invoke-virtual {v9, v6}, Landroid/support/constraint/solver/widgets/ResolutionDimension;->resolve(I)V
    ...
    invoke-virtual {v9, v8}, Landroid/support/constraint/solver/widgets/ResolutionDimension;->resolve(I)V
    ...
    invoke-virtual {v8}, Landroid/support/constraint/solver/widgets/ResolutionDimension;->invalidate()V
    ...
    invoke-virtual {v6}, Landroid/support/constraint/solver/widgets/ConstraintWidgetContainer;->solveGraph()V
    ...
    .end local v23    # "i":I
    .end local v28    # "heightPadding":I
    .end local v29    # "widthPadding":I
    ...
    iget-boolean v11, v8, Landroid/support/constraint/ConstraintLayout$LayoutParams;->isGuideline:Z

    if-nez v11, :cond_2e8

    iget-boolean v11, v8, Landroid/support/constraint/ConstraintLayout$LayoutParams;->isHelper:Z
    ...
    invoke-virtual {v9, v11}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setVisibility(I)V
    ...
    .line 1379
    .local v13, "left":Landroid/support/constraint/solver/widgets/ResolutionAnchor;
    ...
    invoke-virtual {v9, v14}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->getAnchor(Landroid/support/constraint/solver/widgets/ConstraintAnchor$Type;)Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    ...
    .line 1380
    .local v14, "right":Landroid/support/constraint/solver/widgets/ResolutionAnchor;
    ...
    invoke-virtual {v9, v15}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->getAnchor(Landroid/support/constraint/solver/widgets/ConstraintAnchor$Type;)Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    ...
    .line 1383
    .local v10, "top":Landroid/support/constraint/solver/widgets/ResolutionAnchor;
    move/from16 v22, v5
    ...
    .line 1384
    .local v5, "bottom":Landroid/support/constraint/solver/widgets/ResolutionAnchor;
    move/from16 v23, v6
    ...
    .line 1400
    invoke-virtual {v9}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->getResolutionWidth()Landroid/support/constraint/solver/widgets/ResolutionDimension;
    ...
    .line 1403
    invoke-virtual {v9}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->getResolutionHeight()Landroid/support/constraint/solver/widgets/ResolutionDimension;
    ...
    invoke-virtual {v9}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->isSpreadWidth()Z
    ...
    invoke-virtual {v9}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->isSpreadHeight()Z
    ...
    invoke-virtual {v5}, Landroid/support/constraint/solver/widgets/ResolutionAnchor;->isResolved()Z
    ...
    .line 1429
    invoke-virtual {v5}, Landroid/support/constraint/solver/widgets/ResolutionAnchor;->getResolvedValue()F
    ...
    invoke-virtual {v0, v12}, Landroid/support/constraint/solver/widgets/ResolutionDimension;->resolve(I)V
    ...
    invoke-static {v2, v3, v0}, Landroid/support/constraint/ConstraintLayout;->getChildMeasureSpec(III)I
    ...
    .end local v3    # "heightPadding":I
    .end local v4    # "widthPadding":I
    .restart local v28    # "heightPadding":I
    .restart local v29    # "widthPadding":I
    iget-wide v3, v2, Landroid/support/constraint/solver/Metrics;->measures:J

    const-wide/16 v18, 0x1

    add-long v3, v3, v18

    iput-wide v3, v2, Landroid/support/constraint/solver/Metrics;->measures:J
    ...
    :goto_290
    invoke-virtual {v9, v3}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setWidthWrapContent(Z)V
    ...
    :goto_298
    invoke-virtual {v9, v3}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setHeightWrapContent(Z)V
    ...
    .end local v12    # "height":I
    .local v4, "height":I
    invoke-virtual {v9, v3}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setWidth(I)V

    .line 1460
    invoke-virtual {v9, v4}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setHeight(I)V

    .line 1462
    if-eqz v16, :cond_2ae

    .line 1463
    invoke-virtual {v9, v3}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setWrapWidth(I)V
    ...
    .line 1466
    invoke-virtual {v9, v4}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setWrapHeight(I)V
    ...
    invoke-virtual {v11, v3}, Landroid/support/constraint/solver/widgets/ResolutionDimension;->resolve(I)V
    ...
    invoke-virtual {v11}, Landroid/support/constraint/solver/widgets/ResolutionDimension;->remove()V
    ...
    invoke-virtual {v11, v4}, Landroid/support/constraint/solver/widgets/ResolutionDimension;->resolve(I)V
    ...
    .local v11, "params":Landroid/support/constraint/ConstraintLayout$LayoutParams;
    iget-boolean v12, v11, Landroid/support/constraint/ConstraintLayout$LayoutParams;->needsBaseline:Z
    ...
    if-eq v12, v2, :cond_2f3

    .line 1482
    invoke-virtual {v9, v12}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setBaselineDistance(I)V
    ...
    .end local v5    # "bottom":Landroid/support/constraint/solver/widgets/ResolutionAnchor;
    .end local v6    # "bothVertical":Z
    .end local v7    # "resolveWidth":Z
    .end local v8    # "childWidthMeasureSpec":I
    .end local v9    # "widget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    .end local v10    # "top":Landroid/support/constraint/solver/widgets/ResolutionAnchor;
    .end local v11    # "params":Landroid/support/constraint/ConstraintLayout$LayoutParams;
    .end local v12    # "baseline":I
    .end local v13    # "left":Landroid/support/constraint/solver/widgets/ResolutionAnchor;
    .end local v14    # "right":Landroid/support/constraint/solver/widgets/ResolutionAnchor;
    .end local v15    # "bothHorizontal":Z
    .end local v16    # "didWrapMeasureWidth":Z
    .end local v17    # "didWrapMeasureHeight":Z
    .end local v26    # "resolveHeight":Z
...
.method private setChildrenConstraints()V
    ...
    :try_end_48
    .catch Landroid/content/res/Resources$NotFoundException; {:try_start_17 .. :try_end_48} :catch_49
    ...
    invoke-virtual {v9, v0}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setDebugName(Ljava/lang/String;)V
    :try_end_118
    .catch Landroid/content/res/Resources$NotFoundException; {:try_start_e9 .. :try_end_118} :catch_119
    ...
    .local v16, "resolveGoneRightMargin":I
    :goto_21f
    iget v10, v14, Landroid/support/constraint/ConstraintLayout$LayoutParams;->circleConstraint:I

    if-eq v10, v9, :cond_243
