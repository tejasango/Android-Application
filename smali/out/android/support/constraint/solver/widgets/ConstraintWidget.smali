...
.method private applyConstraints(Landroid/support/constraint/solver/LinearSystem;ZLandroid/support/constraint/solver/SolverVariable;Landroid/support/constraint/solver/SolverVariable;Landroid/support/constraint/solver/widgets/ConstraintWidget$DimensionBehaviour;ZLandroid/support/constraint/solver/widgets/ConstraintAnchor;Landroid/support/constraint/solver/widgets/ConstraintAnchor;IIIIFZZIIIFZ)V
    ...
    packed-switch v21, :pswitch_data_3de
    ...
    .restart local v4    # "numConnections":I
    :cond_e9
    move/from16 v26, v4
    ...
    .local v34, "endTarget":Landroid/support/constraint/solver/SolverVariable;
    .local v35, "matchMinDimension":I
    .local v36, "beginTarget":Landroid/support/constraint/solver/SolverVariable;
    :goto_146
    move v8, v1
    ...
    .end local v14    # "numConnections":I
    .end local v33    # "matchConstraintDefault":I
    .end local v34    # "endTarget":Landroid/support/constraint/solver/SolverVariable;
    .end local v35    # "matchMinDimension":I
    .end local v36    # "beginTarget":Landroid/support/constraint/solver/SolverVariable;
    .restart local v1    # "dimension":I
    ...
    .end local v1    # "percentBegin":Landroid/support/constraint/solver/SolverVariable;
    .local v32, "percentBegin":Landroid/support/constraint/solver/SolverVariable;
    ...
    .end local v32    # "percentBegin":Landroid/support/constraint/solver/SolverVariable;
    .local v17, "percentEnd":Landroid/support/constraint/solver/SolverVariable;
    .restart local v31    # "percentBegin":Landroid/support/constraint/solver/SolverVariable;
    :goto_1b7
    ...
    .end local v18    # "endTarget":Landroid/support/constraint/solver/SolverVariable;
    .end local v26    # "numConnections":I
    .restart local v14    # "numConnections":I
    .restart local v34    # "endTarget":Landroid/support/constraint/solver/SolverVariable;
    .restart local v35    # "matchMinDimension":I
    ...
    .end local v6    # "end":Landroid/support/constraint/solver/SolverVariable;
    .local v13, "end":Landroid/support/constraint/solver/SolverVariable;
    .restart local v36    # "beginTarget":Landroid/support/constraint/solver/SolverVariable;
    move/from16 v6, p19
    ...
    invoke-virtual {v10, v13, v7, v1, v6}, Landroid/support/constraint/solver/LinearSystem;->addEquality(Landroid/support/constraint/solver/SolverVariable;Landroid/support/constraint/solver/SolverVariable;II)Landroid/support/constraint/solver/ArrayRow;
    ...
    invoke-virtual {v10, v12, v13, v8, v1}, Landroid/support/constraint/solver/LinearSystem;->addGreaterThan(Landroid/support/constraint/solver/SolverVariable;Landroid/support/constraint/solver/SolverVariable;II)V
    ...
    .line 2784
    invoke-virtual {v10, v13, v7, v8, v6}, Landroid/support/constraint/solver/LinearSystem;->addGreaterThan(Landroid/support/constraint/solver/SolverVariable;Landroid/support/constraint/solver/SolverVariable;II)V
    ...
    invoke-virtual {v10, v13, v5, v6, v1}, Landroid/support/constraint/solver/LinearSystem;->addEquality(Landroid/support/constraint/solver/SolverVariable;Landroid/support/constraint/solver/SolverVariable;II)Landroid/support/constraint/solver/ArrayRow;
    ...
    .end local v14    # "numConnections":I
    .restart local v38    # "numConnections":I
    iget v8, v14, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mResolvedDimensionRatioSide:I
    ...
    invoke-virtual {v10, v13, v5, v1, v6}, Landroid/support/constraint/solver/LinearSystem;->addEquality(Landroid/support/constraint/solver/SolverVariable;Landroid/support/constraint/solver/SolverVariable;II)Landroid/support/constraint/solver/ArrayRow;
    ...
    .end local v6    # "endTarget":Landroid/support/constraint/solver/SolverVariable;
    .local v40, "endTarget":Landroid/support/constraint/solver/SolverVariable;
    move-object v14, v7
    ...
    .end local v28    # "matchConstraintDefault":I
    .end local v40    # "endTarget":Landroid/support/constraint/solver/SolverVariable;
    .local v4, "matchConstraintDefault":I
    .restart local v5    # "endTarget":Landroid/support/constraint/solver/SolverVariable;
    .restart local v7    # "begin":Landroid/support/constraint/solver/SolverVariable;
    :cond_365
    ...
    .restart local v28    # "matchConstraintDefault":I
    .restart local v40    # "endTarget":Landroid/support/constraint/solver/SolverVariable;
    :cond_36f
    :goto_36f
    if-eqz v39, :cond_375
    ...
    invoke-virtual {v10, v14, v0, v5, v2}, Landroid/support/constraint/solver/LinearSystem;->addGreaterThan(Landroid/support/constraint/solver/SolverVariable;Landroid/support/constraint/solver/SolverVariable;II)V
    ...
    .end local v40    # "endTarget":Landroid/support/constraint/solver/SolverVariable;
    .restart local v6    # "endTarget":Landroid/support/constraint/solver/SolverVariable;
    invoke-virtual {v10, v13, v6, v5, v4}, Landroid/support/constraint/solver/LinearSystem;->addLowerThan(Landroid/support/constraint/solver/SolverVariable;Landroid/support/constraint/solver/SolverVariable;II)V
    ...
    invoke-virtual {v10, v14, v11, v12, v5}, Landroid/support/constraint/solver/LinearSystem;->addGreaterThan(Landroid/support/constraint/solver/SolverVariable;Landroid/support/constraint/solver/SolverVariable;II)V

    goto :goto_3b2

    .line 2854
    .end local v2    # "startStrength":I
    .end local v4    # "endStrength":I
    ...
    invoke-virtual {v10, v2, v13, v4, v5}, Landroid/support/constraint/solver/LinearSystem;->addGreaterThan(Landroid/support/constraint/solver/SolverVariable;Landroid/support/constraint/solver/SolverVariable;II)V
    ...
    if-ge v7, v8, :cond_3dd

    if-eqz p2, :cond_3dd

    .line 2750
    invoke-virtual {v10, v14, v11, v4, v5}, Landroid/support/constraint/solver/LinearSystem;->addGreaterThan(Landroid/support/constraint/solver/SolverVariable;Landroid/support/constraint/solver/SolverVariable;II)V
...
.method public addToSolver(Landroid/support/constraint/solver/LinearSystem;)V
    ...
    iget v12, v15, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mMatchConstraintDefaultHeight:I
    ...
    .local v44, "bottom":Landroid/support/constraint/solver/SolverVariable;
    const/4 v0, 0x3
    ...
    if-ne v2, v8, :cond_19e

    if-ne v12, v0, :cond_19e
    ...
    .end local v44    # "bottom":Landroid/support/constraint/solver/SolverVariable;
    .local v0, "bottom":Landroid/support/constraint/solver/SolverVariable;
    ...
    .end local v0    # "bottom":Landroid/support/constraint/solver/SolverVariable;
    .restart local v44    # "bottom":Landroid/support/constraint/solver/SolverVariable;
    :cond_19e
    :goto_19e
    move/from16 v47, v3
    ...
    .local v45, "matchConstraintDefaultHeight":I
    .local v46, "useRatio":Z
    .local v47, "width":I
    .local v48, "height":I
    :goto_1a0
    move/from16 v48, v4
    ...
    .local v40, "horizontalDimensionFixed":Z
    move-object v5, v0
    ...
    .local v43, "verticalParentWrapContent":Z
    move-object v7, v0
    ...
    .local v49, "horizontalParentWrapContent":Z
    move v9, v0
    ...
    .local v50, "baseline":Landroid/support/constraint/solver/SolverVariable;
    move v13, v0
    ...
    .local v51, "top":Landroid/support/constraint/solver/SolverVariable;
    move-object/from16 v1, p1
    ...
    .end local v40    # "horizontalDimensionFixed":Z
    .end local v43    # "verticalParentWrapContent":Z
    .end local v49    # "horizontalParentWrapContent":Z
    .end local v50    # "baseline":Landroid/support/constraint/solver/SolverVariable;
    .end local v51    # "top":Landroid/support/constraint/solver/SolverVariable;
    ...
    .end local v9    # "horizontalParentWrapContent":Z
    .end local v13    # "baseline":Landroid/support/constraint/solver/SolverVariable;
    .restart local v40    # "horizontalDimensionFixed":Z
    .restart local v43    # "verticalParentWrapContent":Z
    .restart local v49    # "horizontalParentWrapContent":Z
    .restart local v50    # "baseline":Landroid/support/constraint/solver/SolverVariable;
    .restart local v51    # "top":Landroid/support/constraint/solver/SolverVariable;
    :goto_25b
